...
(function (app) {
    ...
    productCategoryListController.$inject = ['$scope', '$rootScope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];

    function productCategoryListController($scope, $rootScope, apiService, notificationService, $ngBootbox, $filter) {
        $rootScope.pageTitle = "Danh sách thể loại sản phẩm";
        ...
        function changeStatus(id) {
            ...
            apiService.get('/api/productcategory/changestatus', config, function (result) {
